...
namespace ai
{
    ...
    public:
        ChatActionContext()
        {
            ...
            creators["goaway chat shortcut"] = &ChatActionContext::goaway_chat_shortcut;
    ...
    private:
        ...
        static Action* goaway_chat_shortcut(PlayerbotAI* ai) { return new GoawayChatShortcutAction(ai); }
