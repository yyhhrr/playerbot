...
namespace ai
{
    ...
    public:
        CastBattleMeleeSpellAction(PlayerbotAI* ai, const char* spell) : CastMeleeSpellAction(ai, spell) {}
    ...
    public:
        CastDefensiveMeleeSpellAction(PlayerbotAI* ai, const char* spell) : CastMeleeSpellAction(ai, spell) {}
        virtual NextAction** getPrerequisites() {
