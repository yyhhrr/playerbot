...
public:
    ActionNodeFactoryInternal()
    {
        ...
        creators["add loot"] = &ActionNodeFactoryInternal::add_loot;
        creators["add gathering loot"] = &ActionNodeFactoryInternal::add_gathering_loot;
...
private:
    ...
    static ActionNode* add_loot(PlayerbotAI* ai)
    {
        return new ActionNode ("add loot",
            /*P*/ NULL,
            /*A*/ NULL,
            /*C*/ NULL);
    }
    static ActionNode* add_gathering_loot(PlayerbotAI* ai)
    {
        return new ActionNode ("add gathering loot",
            /*P*/ NULL,
            /*A*/ NULL,
            /*C*/ NULL);
    }
